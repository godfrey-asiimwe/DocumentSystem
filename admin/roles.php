                ...
                <div class="card">
                  <div class="card-header">
                    ...
                    <div class="card-header-action">
                      <button   data-toggle="modal" data-target="#logoutModal" class="dropdown-item has-icon text-danger btn btn-primary" style="color: white !important;" class="btn btn-primary">Add Role</button>
                    </div>
                  </div>
                        ...
                        <?php
                          ...
                          if (! empty($result)) {
                            ...
                            <tr>
                              ...
                              <td> <?php echo $result[$k]["des"]; ?></td>
                              <td><?php echo $result[$k]["Date_created"];?></td>
                              <td> <?php echo $result[$k]["Created_by"];?></td>
        ...
        <div class="modal-body">
          <form id="role">
              <div class="form-group col-md-12 col-lg-12">
               ...
               <button type="button" style="color: white;" id="add_role"   class="btn btn-primary daterange-btn icon-left btn-icon"><i class="fas fa-calendar"></i> Save
                </button> 
          </form>
      </div>
      </div>
